...
const Sidebar = () => {
  ...
  return (
    <>
      <div
        className={`fixed  lg:w-60 lg:block transition-all duration-300 h-screen ${
          mode ? "bg-slate-800 text-slate-300" : "bg-white text-slate-800"
        } ${nav ? "block z-50 w-72" : "hidden"}`}
      >
        <Setting />
        <div className={`${mode ? "" : "bg-slate-200 text-slate-800"}`}>
          <div className="">
